...
const GEN_STRING = "Generated by <a target=\"_blank\" href=\"https://github.com/killerbat00/bhm.sh\">my custom webserver↗</a> written in <a href='https://nim-lang.org' aria-label='Link to the Nim programming language's home page'>Nim↗</a> in $1 ms"
