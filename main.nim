...
const GEN_STRING = "Generated by <a target='_blank' href='https://github.com/killerbat00/bhm.sh' title='Link to webserver source code'>my custom webserver<span aria-hidden='true'>↗</a> written in <a href='https://nim-lang.org' title='Link to the Nim programming language website'>Nim<span aria-hidden='true'>↗</a> in $1 ms"
