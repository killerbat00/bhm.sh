...
const GEN_STRING = "Generated by <a target='_blank' href='https://github.com/killerbat00/bhm.sh' title='Link to webserver source code'>my custom webserver<span aria-hidden='true'>↗</a> written in <a href='https://nim-lang.org' title='Link to the Nim programming language home page'>Nim<span aria-hidden='true'>↗</a> in $1 ms"
const SILLY_STRING = "Made with 🐶 Einstein (my dog). v$1." % VERSION
    ...
    proc handleRequest(req: Request): Future[void] {.async, gcsafe.} =
        ...
        try:
            ...
            # templated files
                ...
                ctx.data.canonicalLink = "<link rel=\"canonical\" href=\"http://bhm.sh/" & requestedUrl & "\">"
