...
const DYNAMIC_FILES = slurpDynamicFiles()
 ...
 # Adds a sequence of routes and a handler to the RouteTable.
...
proc sendResponse(req: Request, res: HttpResponse, start_time: float = 0) {.gcsafe, async.} =
